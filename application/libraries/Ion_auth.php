...

{
	...
	public function register($user_role,$username, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation

	{
...

		{
			...
			$id = $this->ion_auth_model->register($user_role,$username, $password, $email, $additional_data, $group_ids);
