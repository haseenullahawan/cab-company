...
$config['site_title']                 = "VBS";       // Site Title, example.com

$config['admin_email']                = "vechiclebooking@gmail.com"; // Admin Email, admin@example.com

$config['default_group']              = 'members';           // Default group, use name

$config['admin_group']                = 'admin';             // Default administrators group, use name

$config['executives_group']           = 'executives';          // Business User Group

$config['identity']                   = 'email';             // A database column which is used to login with

$config['customer_id']                = 'customer_id';             // A database column which is used to login with
...
$config['email_customer'] = 'customer.tpl.php';

$config['email_invoice'] = 'invoice.tpl.php';
