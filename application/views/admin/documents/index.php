                    ...
                    <div class="module-body table-responsive">
                        ...
                        <table id="example" class="cell-border" cellspacing="0" width="100%" data-selected_id="">
                            ...
                            <tr>
                                ...
                                <th class="column-name" ><?php echo $this->lang->line('view');?></th>
                            ...
                            <?php if(isset($data) && !empty($data)):?>
                                <?php foreach($data as $key => $item):?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?=site_url("admin/documents/".$item->id."/edit")?>">
                                        ...
                                        <td><?=$item->subject;?></td>
                                        <td><a href="<?=site_url("admin/documents/".$item->id."/edit")?>"><button>&nbsp;&nbsp;<?=$this->lang->line('view');?>&nbsp;&nbsp;</button></a></td>
