      ...
      <div class="col-md-12 padding-p-l">
         <div class="module">
            ...
            <div class="module-body">
               <?php 
                  $attributes = array('name' => 'edit_customers_form', 'id' => 'edit_customers_form');
                   echo form_open("admin/editCustomers/".$operation,$attributes) ?>
               <div class="col-md-6">
               ...
               <div class="col-md-6">
                   <div class="form-group">                    
                     ...
                     <input type="text" name="address1" placeholder="<?php echo $this->lang->line('address1');?>" value="<?php 
                        if(isset($user->address1))
                        echo $user->address1;echo set_value('address1');
                        ?>" />   
                     <?php echo form_error('address1');?>				   
                  </div>
                   <div class="form-group">                    
                     <label><?php echo $this->lang->line('address2');?></label>    
                     <input type="text" class="location" id="address2" name="address2" placeholder="<?php echo $this->lang->line('address2');?>" value="<?php 
                        if(isset($user->address2))
                        echo $user->address2;echo set_value('address2');
                        ?>" />   
         ...
         setupFormValidation: function() {
             ...
             $("#edit_customers_form").validate({
                 ...
                 messages: {
                     ...
                     address2: {
                         required: "<?php echo $this->lang->line('billing_address_valid');?>"
                     }
                 },
