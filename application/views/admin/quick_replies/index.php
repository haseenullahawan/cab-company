                    ...
                    <div class="module-body table-responsive">
                        <table id="example" class="cell-border" cellspacing="0" width="100%" data-selected_id="">
                            ...
                            <tr>
                                ...
                                <th class="column-name" ><?php echo $this->lang->line('message_sentence');?></th>
                            ...
                            <?php if(isset($data) && !empty($data)):?>
                                <?php foreach($data as $key => $item):?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?=site_url("admin/quick_replies/".$item->id."/edit")?>">
                                        ...
                                        <td><?=$item->name;?></td>
                                        <td><?php if($item->module == 1){echo 'Job Applications';}else if($item->module == 2){echo 'Quote Requests';}else if($item->module == 3){echo 'Calls';}else if($item->module == 4){echo 'Support';}else{echo '-';} ?></td>
                                        <td><?php $out = strlen($item->message_sentence) > 12 ? substr($item->message_sentence,0,12)."....." : $item->message_sentence; ?><?=$out;?></td>
                                        <td><?php if($item->status == 1){echo 'Enabled';}else{echo 'Disabled';} ?></td>
