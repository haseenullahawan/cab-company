            ...
            <div class="col-md-12">
                ...
                <div class="module">
                    ...
                    <div class="module-body">
                        <?=form_open("admin/quick_replies/".$data->id."/update")?>
                        <div class="row">
                            <div class="col-xs-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-right">
                                    ...
                                    <a href="<?=base_url("admin/quick_replies")?>" class="btn btn-default">Cancel</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
...
<script type="text/javascript">
    function appendText(text){
        CKEDITOR.instances['message_sentence'].insertHtml(text);
    }
</script>