               ...
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  ...
                  <tbody>
                     ...
                     <tr style="background-color:<?php echo $color;?>">
                        <td><?php echo $i; $i++;?></td>
                        <td>
                            <a href="<?php echo site_url(); ?>/admin/bookingDetails/<?php echo $row->id; ?>" target="_blank"><?php echo $row->booking_ref;?></a>
                        </td>
                        ...
                        <td>
                           <div class="btn-group">
                              ...
                              <ul class="dropdown-menu menu-drop" role="menu" aria-labelledby="dLabel">
                                 ...
                                 <li>
                                    <a href="<?php echo site_url(); ?>/settings/bookings/confirm/<?php echo $row->id;?>"><?php echo $this->lang->line('action_confirm');?></a>
                                 </li>
                                 <li>
                                    <a href="<?php echo site_url(); ?>/settings/bookings/cancel/<?php echo $row->id;?>"><?php echo $this->lang->line('action_cancel');?></a>
                                 </li>
