      ...
      <div class="col-md-12 padding-p-r">
         <div class="module">
            <div class="module-head">
               ...
               <a class="btn btn-primary add-btn" href="<?php echo site_url(); ?>/settings/stations/Add">
            ...
            <div class="module-body">
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  <thead>
                     <tr>
                        <th>#</th>
                        <th><?php echo $this->lang->line('station_name');?></th>
                        <th><?php echo $this->lang->line('station_address');?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a class="btn btn-warning" type="button" href="<?php echo site_url(); ?>/settings/stations/Edit/<?php echo $row->id?>" ><i class="fa fa-edit"></i></a>
    ...
    <div class="modal-dialog" style="margin-top:350px;">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <a type="button" class="btn btn-default" id="delete_no" href="<?php echo site_url(); ?>/settings/stations/Delete/<? echo $row->id; ?>"><?php echo $this->lang->line('yes');?></a>
...
<script>
   function changeDeleteId(x) {
   	var str = "<?php echo site_url(); ?>/settings/stations/Delete/" + x;
