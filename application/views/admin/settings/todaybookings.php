               ...
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  <thead>
                     <tr>
                        ...
                        <th><?php 
                           echo $this->lang->line('cost_of_journey')."(".$locale_info['currency_symbol'].")";?></th>
                  ...
                  <tfoot>
                     <tr>
                        ...
                        <th><?php echo $this->lang->line('distance');?></th>
                        <th><?php echo $this->lang->line('vehicle_selected');?></th>
                        <th><?php echo $this->lang->line('cost_of_journey')."(".$locale_info['currency_symbol'].")";?></th>
                        <th><?php echo $this->lang->line('actions');?></th>
                        <th><?php echo $this->lang->line('status');?></th>
                     </tr>
                  </tfoot>
                  <tbody>
                     ...
                     <tr style="background-color:<?php echo $color;?>">
                        ...
                        <td><b><?php echo $row->cost_of_journey;?></b></td>
                        <td>
                           <div class="btn-group">
                              ...
                              <ul class="dropdown-menu menu-drop" role="menu" aria-labelledby="dLabel">
                                 <li>
                                    <a href="<?php echo site_url(); ?>/settings/todayBookings/confirm/<?php echo $row->id;?>"><?php echo $this->lang->line('action_confirm');?></a>
                                 </li>
                                 <li>
                                    <a href="<?php echo site_url(); ?>/settings/todayBookings/cancel/<?php echo $row->id;?>"><?php echo $this->lang->line('action_cancel');?> </a>
                                 </li>
                        ...
                        <td>
                           ...
                           <span class="label label-warning"><?php echo $this->lang->line($row->is_conformed);?></span>
                           <?php } elseif($row->is_conformed=="confirm") { ?>
                           <span class="label label-success"><?php echo $this->lang->line($row->is_conformed);?></span>
                           <?php } elseif($row->is_conformed=="cancelled") {?>
                           <span class="label label-danger"><?php echo $this->lang->line($row->is_conformed);?></span>
                           <?php } ?>
                        </td>
                     </tr>
                     <?php endforeach; ?>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <a type="button" class="btn btn-default" id="delete_no" href="<?php echo site_url(); ?>/settings/todayBookings/Delete/<? echo $row->id; ?>">   <?php echo $this->lang->line('yes');?></a>
...
<script>
   function changeDeleteId(x) {
   	var str = "<?php echo site_url(); ?>/settings/todayBookings/Delete/" + x;
