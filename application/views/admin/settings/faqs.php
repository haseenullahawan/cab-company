      ...
      <div class="col-md-12 padding-p-r">
         <div class="module">
            <div class="module-head">
               ...
               <a class="btn btn-primary add-btn" href="<?php echo site_url(); ?>/settings/faqs/Add">
               ...
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a class="btn btn-warning" type="button" href="<?php echo site_url(); ?>/settings/faqs/Edit/<?php echo $row->id?>" ><i class="fa fa-edit"></i></a>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <a type="button" class="btn btn-default" id="delete_no" href="<?php echo site_url(); ?>/settings/faqs/Delete/<? echo $row->id; ?>"><?php echo $this->lang->line('yes');?></a>
...
<script>
   function changeDeleteId(x) {
  	var str = "<?php echo site_url(); ?>/settings/faqs/Delete/" + x;
