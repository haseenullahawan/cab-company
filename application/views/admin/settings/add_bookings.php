            ...
            <div class="module-body">
               <div class="col-md-6">
                  <div class="form-group">                    
                     ...
                     <input class="location" type="text" name="local_pick" id="local_pick" value="<?php echo set_value('local_pick');?>" placeholder="25th Street, San Francisco, CA, United States"/>    
                  </div>
                  <?php echo form_error('local_pick');?>
                  <div class="form-group">                    
                     <label><?php echo $this->lang->line('destination');?></label>    
                     <input class="location" type="text" name="local_drop" id="local_drop" alt="admin_booking" value="<?php echo set_value('local_drop');?>" placeholder="19th Street, San Francisco, CA, United States"/>    
                  </div>
                  <?php echo form_error('local_drop');?>				  
                  <div class="form-group">                    
                     <label><?php echo $this->lang->line('distance');?></label>    
                     <input type="text" name="distance" id="distance" readonly  placeholder="<?php echo $this->lang->line('distance');?>" value="<?php echo set_value('distance');?>"/>    
                  </div>
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">                    
                     ...
                     <input type="text" name="customer_name" placeholder="<?php echo $this->lang->line('customer_name');?>" value="<?php echo set_value('customer_name');?>" />    
                  </div>
                  <?php echo form_error('customer_name');?>				  
                  <div class="form-group">                    
                     <label><?php echo $this->lang->line('phone');?></label>    
                     <input type="text" name="customer_phone" maxlength="11" placeholder="<?php echo $this->lang->line('customer_phone');?>" value="<?php echo set_value('customer_phone');?>"/>    
                  </div>
                  <?php echo form_error('customer_phone');?>	
                  <div class="form-group">                    
                     <label><?php echo $this->lang->line('email');?></label>    
                     <input type="text" name="customer_email" placeholder="<?php echo $this->lang->line('customer_email');?>" value="<?php echo set_value('customer_email');?>" />    
                  </div>
                  ...
                  <div class="form-group">                    
                     ...
                     <input type="text" name="total_cost" id="total_cost" readonly placeholder="<?php echo $this->lang->line('cost');?>" value="<?php echo set_value('total_cost');?>" />    
                  </div>
