      ...
      <div class="col-md-12 padding-p-r">
         <div class="module">
            <div class="module-head">
               ...
               <a class="btn btn-primary add-btn" href="<?php echo site_url(); ?>/settings/vehicleFeatures/Add">
            ...
            <div class="module-body">
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  ...
                  <tbody>
                     <?php 
                        $i=1;
                        foreach($vehicle_features as $row):?>
                     <tr>
                        <td><?php echo $i; $i++;?></td>
                        <td><?php echo $row->features;?></td>
                        <td><?php echo $row->status;?></td>
                        <td>
                           <a class="btn btn-warning" type="button" href="<?php echo site_url(); ?>/settings/vehicleFeatures/Edit/<?php echo $row->id?>" ><i class="fa fa-edit"></i></a>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <a type="button" class="btn btn-default" id="delete_no" href="<?php echo site_url(); ?>/settings/vehicleFeatures/Delete/<? echo $row->id; ?>">  <?php echo $this->lang->line('yes');?></a>
...
<script>
   function changeDeleteId(x) {
   	var str = "<?php echo site_url(); ?>/settings/vehicleFeatures/Delete/" + x;
