      ...
      <div class="col-md-12 padding-p-r">
         <div class="module">
            <div class="module-head">
               ...
               <a class="btn btn-primary add-btn" href="<?php echo site_url(); ?>/settings/airports/Add">
            ...
            <div class="module-body">
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  <thead>
                     <tr>
                        <th>#</th>
                        <th><?php echo $this->lang->line('airport_name');?></th>
                        <th><?php echo $this->lang->line('airport_address');?></th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a class="btn btn-warning" type="button" href="<?php echo site_url(); ?>/settings/airports/Edit/<?php echo $row->id?>" ><i class="fa fa-edit"></i></a>
...
<script>
   function changeDeleteId(x) {
   	var str = "<?php echo site_url(); ?>/settings/airports/Delete/" + x;
