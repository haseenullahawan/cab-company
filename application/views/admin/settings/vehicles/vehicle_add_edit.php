...
<?php $locale_info = localeconv(); ?>
        ...
        <div class="col-md-12 padding-p-l">
          ...
          <div class="module">           
		   ...
		   <div class="module-head">
				...
				<a class="btn btn-primary add-btn" href="<?php echo site_url(); ?>/vehicle_settings/vehicles">
            ...
            <div class="module-body">
              ...
              <div class="col-md-6">
                  ...
                  <label>
                    <?php echo $this->lang->line('category'); ?>
						 ...
						 <?php
							...
							if (isset($edit_data->category_id))
								$sel = $edit_data->category_id;
								echo set_value('category_id');
                   ...
                   <div class="form-group">
                     <label>
                       ...
                       <input type="text" name="name" placeholder="<?php echo $this->lang->line('car_name');?>" value="<?php if (isset($edit_data->name)) echo $edit_data->name; echo set_value('name');?>"/>
				   ...
				   <div class="form-group">
                     ...
                     <input type="text" name="model" placeholder="<?php echo $this->lang->line('model');?>" value="<?php if (isset($edit_data->model)) echo $edit_data->model;echo set_value('model');?> "/>
                   ...
                   <div class="form-group">
                     <label>
                       <?php echo $this->lang->line('passenger_capacity'); ?>
                     </label>
                     <input type="text" name="passengers_capacity" placeholder="<?php echo $this->lang->line('no_of_passengers');?>" value="<?php if (isset($edit_data->passengers_capacity)) echo $edit_data->passengers_capacity;echo set_value('passenger_capacity'); ?>"/>
                   ...
                   <div class="form-group">
                     <label>
                       <?php echo $this->lang->line('large_luggage_capacity'); ?>
                     </label>
                     <input type="text" name="large_luggage_capacity" placeholder="<?php echo $this->lang->line('in_kgs');?>" value="<?php if (isset($edit_data->large_luggage_capacity)) echo $edit_data->large_luggage_capacity; echo set_value('large_luggage_capacity');?>"/>
                   ...
                   <div class="form-group">
                     <label>
						 <?php echo $this->lang->line('wheelchair'); ?>
                     </label>
                     <input type="text" name="small_luggage_capacity" placeholder="<?php echo $this->lang->line('no_of_wheelchairs');?>" value="<?php if (isset($edit_data->small_luggage_capacity)) echo $edit_data->small_luggage_capacity; echo set_value('small_luggage_capacity');?>"/>
					...
					?>
				 <img id="vehicle_image" src="<?php echo $src;?>" height="120" style="<?php echo $style;?>" />
				   ...
				   <div class="form-group">
                     ...
                     <input type="text" name="description" placeholder="<?php echo $this->lang->line('eg_car_conditions_etc');?>" value="<?php if (isset($edit_data->description)) echo $edit_data->description; ?>"/>
                   </div>
                 </div>
                 <!-- another div -->
                 <div class="col-md-6">
                   ...
                   <div class="form-group">
                     <label>
                        <?php echo $this->lang->line('total_vehicles'); ?>
                     </label>
                     <input type="text" name="total_vehicles"  placeholder="<?php echo $this->lang->line('total_number_of_vehicles_available');?>" value="<?php if (isset($edit_data->total_vehicles)) echo $edit_data->total_vehicles; ?>"/>
                    </div>
					
					<div class="form-group">
                     <label>
                        <?php echo $this->lang->line('cost')." ".$this->lang->line('starting')." ".$this->lang->line('from')." (".$locale_info['currency_symbol'].")";  ?>
						
                     </label>
                     <input type="text" name="starting_cost" value="<?php if (isset($edit_data->cost_starting_from)) echo $edit_data->cost_starting_from;echo set_value('starting_cost'); ?>"/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="radio" name="waiting_time" id="waiting_time_enable" value="enable" <?php //if (isset($edit_data->waiting_time)) { if($edit_data->waiting_time == "enable") echo "checked"; } else echo "checked"; ?> class="css-radio css-label" onclick="action_waiting_cost_div();"> 
						<label class="css-label" for="waiting_time_enable"> <?php //echo $this->lang->line('enable');?></label>
					&nbsp;&nbsp;&nbsp;
                      <input type="radio" name="waiting_time" id="waiting_time_disable" value="disable" <?php //if (isset($edit_data->waiting_time)) { if($edit_data->waiting_time == "disable") echo "checked"; } ?> class="css-radio css-label" onclick="action_waiting_cost_div();"> 
					    <label class="css-label" for="waiting_time_disable">   <?php //echo $this->lang->line('disable');?></label>
					
                    </div>
					
					<div id="wt_div" <?php //if (isset($edit_data->waiting_time)) { if($edit_data->waiting_time == "disable") echo "style='display:none;'"; } ?>>
					<p id="wt_text">* Set costs for waiting time.</p>
					<table width="100%" id="wt_enabled_table" >
					  <thead>
							<tr>
								<th>#</th>
								<th><?php //echo $this->lang->line('from_time')." (".$this->lang->line('in_mins').")";?></th>
								<th><?php //echo $this->lang->line('to_time')." (".$this->lang->line('in_mins').")";?></th>					
						...
						<tbody>
							...
							<?php //if(isset($wtCosts) && count($wtCosts)>0) {
							
								//$j = 1;
								
								//foreach($wtCosts as $c) {
							
							?>
						
							<tr id="tr_<?php //echo $j;?>">
								<td></td>
								<td>	 
									 <input type="text" id="fromTime_<?php //echo $j;?>" placeholder="From Time in Mins" value="<?php //echo $c->from_time;?>" onblur="if(isNaN(parseInt(this.value)) || this.value == 0) { window.alert('Value must be greater than 0.'); this.value = 11;}">
								</td>
								<td>	 
									 <input type="text" id="toTime_<?php //echo $j;?>" placeholder="To Time in Mins" value="<?php //echo $c->to_time;?>" onblur="setFromTime(<?php //echo $j;?>, this.value);">
								</td>
								<td>	 
									<input type="text" id="wCost_<?php //echo $j;?>" placeholder="Waiting Cost" value="<?php //echo $c->cost;?>" onblur="if(isNaN(parseFloat(this.value)) || this.value == 0 || this.value == 0.00) { window.alert('Value must be greater than 0.'); this.value = '0.00';}">
								</td>
								
								<td><?php //if($j != 1) { ?><a onclick="deleteRow(<?php //echo $j;?>,'wt_enabled_table')" style="cursor:pointer;" title="Delete Row"> <i class="fa fa-trash"></i></a><?php //} $j++;?></td>
							</tr>
							...
							<?php //} } else { ?>
								...
								<td></td>
								<td>	 
									 <input type="text" id="fromTime_1" placeholder="From Time in Mins" style="display:none;" onblur="if(isNaN(parseInt(this.value)) || this.value == 0) { window.alert('Value must be greater than 0.'); this.value = 11;}">
								</td>
								<td>	 
									 <input type="text" id="toTime_1" placeholder="To Time in Mins" style="display:none;" onblur="setFromTime(1, this.value);">
								</td>
								<td>	 
									<input type="text" id="wCost_1" placeholder="Waiting Cost" value="0.00" style="display:none;" onblur="if(isNaN(parseFloat(this.value)) || this.value == 0 || this.value == 0.00) { window.alert('Value must be greater than 0.'); this.value = '0.00';}">
								</td>
						...
						<input type="hidden" name="wt_data" id="wt_data" >
                   ...
                   <div class="form-group">
					...
					<p id="ct_flat_text">* Set flat costs per KM.</p>
					<table width="100%">
					
					 <tr>
					<td></td>
					<td>Min. Distance (in KMs)</td>
					<td>Min. Cost (<?php echo $locale_info['currency_symbol'];?>)</td>
					</tr>
					<tr>
					...
					<tr>
						<td> <?php echo $this->lang->line('flat')." ".$this->lang->line('cost')." (per KM)";?> </td>
					...
					<p id="ct_incr_text">* Set incremental costs for first m-n km, second m-n km etc.</p>
					<table width="100%" id="ct_incr_table" >
					  <thead>
							<tr>
								<th>#</th>
								<th><?php echo $this->lang->line('from')." (".$this->lang->line('in_kms').")";?></th>
								<th><?php echo $this->lang->line('to')." (".$this->lang->line('in_kms').")";?></th>					
								<th><?php echo $this->lang->line('day')." ".$this->lang->line('cost')." (".$this->lang->line('per_km').")";?></th>
								<th><?php echo $this->lang->line('night')." ".$this->lang->line('cost')." (".$this->lang->line('per_km').")";?></th>
								<th> <i class="fa fa-trash"></i></th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<?php } } else { ?>
								...
								<td></td>
								<td>	 
									 <input type="text" name="fromKm" id="fromKm_1" placeholder="<?php echo $this->lang->line('from_in_kms');?>" style="display:none;" onblur="if(isNaN(parseInt(this.value)) || this.value == 0) { window.alert('Value must be greater than 0.'); this.value = 1;}">
								</td>
								<td>	 
									 <input type="text" name="toKm" id="toKm_1" placeholder="<?php echo $this->lang->line('to_in_kms');?>" style="display:none;" onblur="setFromKm(1, this.value);">
								</td>
								<td>	 
				...
				<input name="Id_to_update" id="Id_to_update" type="hidden" value="<?php if(isset($edit_data->id)) echo $edit_data->id; ?>">
				 <br/>
                 <div class="col-md-6">
                   <input type="submit" value="<?php if(isset($edit_data->id)) echo $this->lang->line('update'); else echo $this->lang->line('add');?>" id="submitbtn" name="submit" class="right-p">
                 </div>
	...
	function appendRows(no_of_rows_to_append)
	{
		...
		for(r=0; r<no_of_rows_to_append; r++) {
			...
			$('#ct_incr_table tbody').append('<tr id="r_'+rowNo+'"><td></td><td><input type="text" id="fromKm_'+rowNo+'" placeholder="From (in KMs)" style="display:none;"></td><td><input type="text" id="toKm_'+rowNo+'" placeholder="To (in KMs)" style="display:none;" onblur="setFromKm('+rowNo+', this.value);"></td><td><input type="text" id="dayCost_'+rowNo+'" placeholder="Day Cost" style="display:none;" value="0.00" onblur="if(isNaN(parseFloat(this.value)) || this.value == 0) { window.alert(\'Value must be greater than 0.\'); this.value = \'0.00\';}"></td><td><input type="text" id="nightCost_'+rowNo+'" placeholder="Night Cost" style="display:none;" value="0.00" onblur="if(isNaN(parseFloat(this.value)) || this.value == 0) { window.alert(\'Value must be greater than 0.\'); this.value = \'0.00\';}"></td><td><a onclick="deleteRow('+rowNo+',\'ct_incr_table\')" style="cursor:pointer;" title="Delete Row"><i class="fa fa-trash"></i></a></td></tr>');
