<div class="col-md-10 padding white right-p">
   <div class="content">
      ...
      <div class="col-md-12 padding-p-r">
         <div class="module">
            <div class="main-hed"> 
               <?php echo $this->lang->line('airport_locations');?>
            </div>
            <div class="module-head">
               <h3><?php echo $this->lang->line('airport_locations');?></h3>
               <a class="btn btn-primary add-btn" href="<?php echo site_url(); ?>/settings/airportLocations/Add">
            ...
            <div class="module-body">
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  ...
                  <tbody>
                     <?php 
                        $i=1;
                        foreach($airport_locations as $row):?>
                     <tr>
                        <td><?php echo $i; $i++;?></td>
                        <td><?php echo $row->location_name;?></td>
                        <td><?php echo $row->status;?></td>
                        <td>
                           <a class="btn btn-warning" type="button" href="<?php echo site_url(); ?>/settings/airportLocations/Edit/<?php echo $row->id;?>" ><i class="fa fa-edit"></i></a>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <a type="button" class="btn btn-default" id="delete_no" href="<?php echo site_url(); ?>/settings/airportLocations/Delete/<? echo $row->id; ?>"> <?php echo $this->lang->line('yes');?></a>
...
<script>
   function changeDeleteId(x) {
   	var str = "<?php echo site_url(); ?>/settings/airportLocations/Delete/" + x;
