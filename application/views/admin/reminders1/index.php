                            ...
                            <?php if(isset($data) && !empty($data)):?>
                                <?php foreach($data as $key => $item):?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?=site_url("admin/reminders1/".$item->id."/edit")?>">
                                        ...
                                        <td><?=$item->name;?></td>
                                        <td><?php if($item->module == 1){echo 'Job Applications';}else if($item->module == 2){echo 'Quote Requests';}else if($item->module == 3){echo 'Calls';}else if($item->module == 4){echo 'Quote Invoices';}else if($item->module == 5){echo 'Support';}else{echo '-';} ?></td>
                                        ...
                                        <td><?=$item->subject;?></td>
                                        <td><?php if($item->reminder_status == 1){echo 'Enabled';}else{echo 'Disabled';} ?></td>
