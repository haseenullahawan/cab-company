            ...
            <div class="col-md-12">
                ...
                <div class="module">
                    ...
                    <div class="module-body">
                        <?=form_open("admin/newsletter/add")?>
                        <div class="row">
                            <div class="col-xs-3">
                            ...
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="user_type" required>
                                        ...
                                        <option <?=set_value('user_type',$this->input->post('user_type')) == $user_type ? "selected" : ""?> value="<?=$user_type?>"><?=$user_type?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <!--<label>Date*</label>-->
                                    <input type="text" class="bdatepicker form-control" name="send_date" placeholder="Date" value="<?=set_value('send_date',$this->input->post('send_date'))?>">
                                </div>
                            </div>
                            <div class="col-xs-2">
                                <div class="form-group">
