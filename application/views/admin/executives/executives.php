      ...
      <div class="col-md-12 padding-p-r">
         <div class="module">
            <div class="module-head">
               ...
               <a class="btn btn-primary add-btn" href="<?php echo site_url(); ?>/admin/addExecutives">
               ...
               <table id="example" class="cell-border example" cellspacing="0" width="100%">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <?php echo ($row->active) ? anchor("admin/deactivate/".$row->id."/exe", lang('index_active'),'class="btn btn-primary"') : anchor("admin/activate/". $row->id."/exe", lang('index_inactive'),'class="btn btn-warning"');?>
                           <?php echo anchor('admin/editExecutive/Edit/'.$row->id,'<i class="fa fa-edit"></i>','class="btn btn-success"'); ?>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <a type="button" class="btn btn-default" id="delete_no" href="<?php echo site_url(); ?>/admin/deleteExecutive/Delete/<? echo $row->id; ?>"> <?php echo $this->lang->line('yes');?></a>
...
<script>
   function changeDeleteId(x) {
   	var str = "<?php echo site_url(); ?>/admin/deleteExecutive/Delete/" + x;
