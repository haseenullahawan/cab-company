                        ...
                        <div id="user-nav">
                            ...
                            <div class="btn-group" role="group" aria-label="">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#myModal"
                                       ...
                                       style="color: #000000db;background-color: #e0e0e0;border-color: #dbdbdb;">
                                        ...
                                        <span class="badge badge-danger navbar-badge" id="header_pending_msg_count" style="display: none;">
                                ...
                                <div class="btn-group" role="group">
                                   ...
                                   <i id="topbar_time"><?php echo date('d/m/Y H:i:s'); ?></i>
                              ...
                              <!--   <div class="btn-group" role="group">
                                  <div style="width:316px;">
                                    <a class="weatherwidget-io" href="https://forecast7.com/fr/48d862d35/paris/" data-icons="Climacons" data-mode="Forecast" data-theme="pure" >Paris, France</a>
                                <script>
                                ...
                                ?>
                                 <div class="btn-group" role="group">
                                    <a class="btn btn-default btn-mar" style="color: #000000db;" href="<?= base_url(); ?>admin/clients.php"><i class="fa fa-users" style="font-size: 15px;margin-right: 5px;"></i><span class="badge badge-danger navbar-badge">0</span>Clients</a>
                                </div>
                                <div class="btn-group" role="group">
                                    <a class="btn btn-default btn-mar" style="color: #000000db;" href="<?= base_url(); ?>admin/affiliates.php"><i class="fa fa-registered" style="font-size: 15px;margin-right: 5px;"></i><span class="badge badge-danger navbar-badge">0</span>Affiliate</a>
                                </div>
                                <div class="btn-group" role="group">
                                    <a class="btn btn-default btn-mar" style="color: #000000db;" href="<?= base_url(); ?>admin/cars.php"><i class="fa fa-car" style="font-size: 15px;margin-right: 5px;"></i><span class="badge badge-danger navbar-badge">0</span>Cars</a>
                                </div>
                                <div class="btn-group" role="group">
                                    <a class="btn btn-default btn-mar" style="color: #000000db;" href="<?= base_url(); ?>admin/drivers.php"><i class="fa fa-user" style="font-size: 15px;margin-right: 5px;"></i><span class="badge badge-danger navbar-badge">0</span>Drivers</a>
                                </div>
                                    ...
                                    <div class="right">
                                        ...
                                        <div class="tot-top">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="<?php echo base_url('admin/weather'); ?>" class="btn-default"><i class="fa fa-fw fa-cloud"></i> Weather</a></li>
                        ...
                        <ul class="nav navbar-nav menu">
                            ...
                            <li <?php if (isset($active_class)) {
                              ...
                              <li <?php if (isset($active_class)) {
                                ...
                                if ($active_class == "add_job") echo 'class="active"';



                            } ?>><a href="<?php echo site_url('admin/add_jobs'); ?>"><i class="" style="font-size: 15px;margin-right: 5px;"></i>Add Jobs</a>
                          ...
                          <li <?php if (isset($active_class)) {
                                ...
                                if ($active_class == "Recurimentconfig") echo 'class="active"';



                            } ?>><a href="<?php echo site_url('admin/Rectruitement_config'); ?>"><i class="fa fa-setting" style="font-size: 15px;margin-right: 5px;"></i>Rectruitement </a>
                            ...
                            } ?>><a href="<?php echo site_url('admin/cars'); ?>"><i class="fa fa-car"
                            ...
                            } ?>><a href="#"><i class="fa fa-user" style="font-size: 15px;margin-right: 5px;"></i>Drivers</a>
                            ...
                            <li <?php // if (isset($active_class)) { // if ($active_class == "calls") echo 'class="active"'; } ?>>



                                <a href="<?php // echo site_url('admin/calls'); ?>"><i class="fa fa-phone" style="font-size: 15px;margin-right: 5px;"></i><span><?php // echo $this->lang->line('calls'); ?></span></a>
                            ...
                            <li <?php // if (isset($active_class)) { // if ($active_class == "jobs") echo 'class="active"';} ?>>



                                <a href="<?php // echo site_url('admin/jobs'); ?>"><i class="fa fa-registered" style="font-size: 15px;margin-right: 5px;"></i><span><?php // echo $this->lang->line('jobs'); ?></span></a>
                            ...
                            <li <?php // if (isset($active_class)) { // if ($active_class == "request") echo 'class="active"'; } ?>>



                                <a href="<?php // echo site_url('admin/request'); ?>"><i class="fa fa-paper-plane" style="font-size: 15px;margin-right: 5px;"></i>Quote Requests</a>
                            ...
                            <li <?php if (isset($active_class)) {
                                ...
                                if ($active_class == "bookings") echo 'class="active"';



                            } ?>><a href="<?php echo site_url('admin/bookings'); ?>"><i class="fa fa-ticket" style="font-size: 15px;margin-right: 5px;"></i>Bookings</a>
                            ...
                            <li <?php if (isset($active_class)) {
                                ...
                                if ($active_class == "quotes") echo 'class="active"';



                            } ?>><a href="<?php echo site_url('admin/quotes'); ?>"><i class="fa fa-paper-plane" style="font-size: 15px;margin-right: 5px;"></i>Quotes</a>
                           ...
                           <li <?php if (isset($active_class)) { if ($active_class == "dispatch") echo 'class="active"'; } ?>>
                            ...
                            <li <?php if (isset($active_class)) { if ($active_class == "support") echo 'class="active"'; } ?>>
                                ...
                                <a href="<?php echo base_url() ?>admin/support.php"><i class="fa fa-child" style="font-size: 15px;margin-right: 5px;"></i><span><?php echo $this->lang->line('support'); ?></span></a>
                            ...
                            <!--    <a href="<?php echo base_url() ?>admin/cms.php"><i class="fa fa-pencil" style="font-size: 15px;margin-right: 5px;"></i><span>CMS</span></a>-->
                            ...
                            <!-- <li <?php i//f (isset($active_class)) { if ($active_class == "drivers_requests") echo 'class="active"'; } ?>>



                                <a href="<?php //echo base_url() ?>admin/drivers_requests"><i class="fa fa-user" style="font-size: 15px;margin-right: 5px;"></i><span>Drivers Requests</span></a>
                            ...
                            <li>
                                ...
                                <a href="<?php echo base_url() ?>admin/infraction">

                                    <i class="fa fa-connectdevelop" style="font-size: 15px;margin-right: 5px;"></i>
                            ...
                            <li>
                                ...
                                <a href="<?php echo site_url('admin/Recurimentconfig'); ?>">

                                    <i class="fa fa-registered" style="font-size: 15px;margin-right: 5px;"></i>

                                    <span>Recrutement Affiliation</span>
...
<!-- 
                            <li <?php if (isset($active_class)) {
                                ...
                                if ($active_class == "cms") echo 'class="active"';



                            } ?>><a href="<?php echo base_url('cms/index'); ?>"><i class="fa fa-bolt" style="font-size: 15px;margin-right: 5px;"></i></a>
                            ...
                            <!-- <li <?php // if (isset($active_class)) {
                                ...
                                // if ($active_class == "supplier") echo 'class="active"';



                            // } ?>><a href="<?php echo site_url('admin/supplier'); ?>"><i class="fa fa-user" style="font-size: 15px;margin-right: 5px;"></i>supplier</a>
                            ...
                            <!-- <li <?php //if (isset($active_class)) {
                               ...
                               // if ($active_class == "bills") echo 'class="active"';



                           // } ?>><a href="<?php echo site_url('admin/bills'); ?>"><i class="fa fa-calculator" style="font-size: 15px;margin-right: 5px;"></i>bills</a>
