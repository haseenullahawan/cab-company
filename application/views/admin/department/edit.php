            ...
            <div class="col-md-12">
                ...
                <div class="module">
                    ...
                    <div class="module-body">
                        <?=form_open("admin/departments/".$row_data['id']."/update")?>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-xs-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name="description" placeholder="Description"><?=$row_data['description']?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <?php foreach($modules as $module){ ?>
                                            <div class="row module_name_row">
                                                ...
                                                <div class="col-xs-2">
                                                    <input type="checkbox" <?php if(in_array($module['id'], $row_modules)){ echo 'checked="checked"'; } ?> name="module[]" value="<?= $module['id']; ?>">
                                                </div>
                                            </div>
                                        <?php } ?>
                                    </div>
