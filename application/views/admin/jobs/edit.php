            ...
            <div class="col-md-12">
                ...
                <div class="module">
                    ...
                    <div class="module-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" class="bdatepicker form-control" name="dob" placeholder="Date de naissance" value="<?=set_value('dob',from_unix_date($data->dob))?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-4">
                                ...
                                <label>Addresse de facturation et du devis*</label>
                                    <div class="input-group">
                                        ...
                                        <input id="address1" value="<?=set_value('address1',@$data->address1)?>" type="text" class="form-control" required name="address1" placeholder="Addresse de facturation et du devis*">
                                    </div>
                                </div>
                            </div>
                             <div class="col-xs-4">
                                ...
                                <label>Complément d'adresse*</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                        <input id="address2" value="<?=set_value('address2',@$data->address2)?>" type="text" class="form-control" required name="address2" placeholder="complément d'adresse*">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" maxlength="20" class="form-control" required name="postal_code" placeholder="Code postal*" value="<?=set_value('postal_code',$data->postal_code)?>">
                                </div>
                            </div>
                        </div>
                         <div class="row">
                              ...
                              <div class="col-xs-4">
                                <div class="form-group">
                                <label>Ville*</label>
                                        <input type="text" class="form-control" value="<?=set_value('ville',@$data->ville)?>" required name="ville" placeholder="Ville*">
                                </div>
                            </div> 
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="situation" required>
                                                  <option <?= @$data->situation == 'retirement' ? 'selected' : ''; ?> value="retirement">Retirement</option>
                                                 <option <?= @$data->situation == 'unemployment' ? 'selected' : ''; ?> value="unemployment">Unemployment</option>
                                                <option <?= @$data->situation == 'rsa' ? 'selected' : ''; ?> value="rsa">RSA</option>
                                                <option <?= @$data->situation == 'onpole' ? 'selected' : ''; ?> value="onpole">En poste</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <?php } ?>
                        <br>
                        <?=form_open("admin/jobs/".$data->id . "/reply", 'enctype="multipart/form-data"')?>
