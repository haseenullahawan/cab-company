            ...
            <div class="col-md-12">
                ...
                <div class="module">
                    ...
                    <div class="module-body">
                        ...
                        <?php } ?>
                        <br>
						<?php /* if(!empty($previous_replies)){ ?>
						<div class="row replyDiv">
							<?php foreach($previous_replies as $k=>$v){ ?>
                            <div class="row message_box">
								<div class="col-xs-12">
									<div class="row">
										<div class="col-md-8">
											<?php $user = $obj->AddedBy($v->addedBy); ?>
											<label>Added by <?php echo $user->first_name.' '.$user->last_name; ?> from <?php echo $user->department; ?> - <?php echo $v->created_on; ?></label>
										</div>
										<div class="col-md-4">
								...
								<div class="col-xs-12">
									<div class="row">
										<div class="col-md-8">
											<label>Message:</label>
												<?php
													$mess1 = str_replace("{sender_name}",$user->first_name." ".$user->last_name,$v->message);
													$mess2 = str_replace("{user_name}",$user->username,$mess1);
													$mess3 = str_replace("{department_name}",$user->department,$mess2);
													$mess4 = str_replace("{support_status}",$data->status,$mess3);
								...
								<div class="col-md-12">
									<div class="row">
										...
										<div class="col-md-5">
											<div class="form-group">
												<?php foreach(explode(",",$v->attachments) as $key=>$val){ ?>
												<a href="<?php echo site_url('uploads/attachment').'/'.$val; ?>"><?php echo $val; ?></a><br/>
												<?php } ?>
											</div>
										</div>
									</div>
                        ...
                        <br>
						<?php } */?>
                        <?=form_open("admin/support/".$data->id . "/reply", 'enctype="multipart/form-data"')?>
                        <div class="row replyDiv">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>Message*</label>
