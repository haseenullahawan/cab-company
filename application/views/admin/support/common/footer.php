    ...
    <script class="init">
        ...
        var datatables = $('#example').DataTable({
            ...
            initComplete: function(){
                $("div.toolbar")
                    .html('<a href="<?=base_url("user/$active_class/ticket_add.php")?>" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> Add</a> <a href="#" class="btn btn-sm btn-default editBtn"><i class="fa fa-pencil"></i> Edit</a> <a href="#" class="btn btn-sm btn-default delBtn"><i class="fa fa-trash"></i> Delete</a>');
...
<script>
    ...
    $(function () {
        $(document.body).on("click",".editBtn",function () {
            ...
            if(selected != ""){
                location.href = "<?=site_url();?>user/<?=@$active_class?>/" + selected + "/ticket_edit.php"
            } else
        ...
        $(document.body).on("click",".delBtn",function () {
            var selected = $("#example").attr("data-selected_id");
            if(selected != ""){
                location.href = "<?=site_url();?>user/<?=@$active_class?>/" + selected + "/ticket_delete.php"
            } else
