                       ...
                       <!--  <form method="post" action="<?= base_url('language/store_language'); ?>" enctype="multipart/form-data" accept-charset="utf-8" > -->
                          ...
                          <div class="col-xs-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="language" name="language" aria-describedby="languageHelp" placeholder="Enter Language">
                          ...
                          <div class="col-xs-4">
                            <div class="form-group">
                              ...
                              <small id="languageHelp" class="form-text text-muted">Only put PNG file</small>
                            </div>
                          </div>
                          <div class="col-xs-12">
                            <div class="text-right">
                                <button type="submit" class="btn btn-default">Save</button>
                                <a href="<?= base_url('admin/language/add'); ?>" class="btn btn-default">Cancel</a>
                            </div>
                          </div>
                        <!-- </form> -->
                        <?php echo form_close(); ?>
