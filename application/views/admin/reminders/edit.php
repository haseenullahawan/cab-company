                            ...
                            <div class="col-xs-5">
                                ...
                                <div class="attach-div" id="attachDiv" style="margin-top: -33px;">
                                    <div class="attach-main" style="margin-left: 20px;">
                                        ...
                                        <?php }else{ ?>
                                            <?php $i = 0; $reminder_days = explode(',', $data->reminder_days);
                                                foreach ($reminder_days as  $r) {
                                            ?>
                                                <div>
                                                    <div class="attach-file"> 
                                                        <input class="form-control" type="number" min="1" max="100" value="<?=$r?>" name="reminder_days[]"> 
                                                    </div> 
                                                    <div class="attach-buttons"> 
