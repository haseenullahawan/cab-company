...
<html lang="en">
   <head>
      ...
      <title>Welcome To Digi Vehicle Booking System ( VBS )</title>
      <!-- Bootstrap -->
   ...
   <body class="emailr">
      ...
      <div class="container-fluid content-bg">
         ...
         <div class="container emailer-wi">
            <h3><?php echo $this->lang->line('welcome_vbs');?></h3>
      ...
      <div class="panel-footer padding">
         <div class="container-fluid copy">
            <div class="container padding">
               <div class="col-md-5"><?php echo $this->lang->line('bottom_message');?></div>
            </div>
         </div>
      </div>
      <!-- Footer-->     
