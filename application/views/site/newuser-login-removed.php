                ...
                <div id="total-login">
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="input-group fe input-group-lg in-ty">
                            ...
                            <input type="text" name="username" value="" id="identity" class="user valid" placeholder="Email">
                            
                        </div>
                    </div>
                    <div class="col-md-12 col-xs-12">
                        <div class="input-group fe input-group-lg in-ty">  
                          <input type="password" name="password" value="" id="password" placeholder="Mot de passe" class="password error">
