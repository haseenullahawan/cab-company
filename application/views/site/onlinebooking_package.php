               ...
               <div class="col-md-12 padding-p-0">
                    <div class="bcp">
                        <ul class='nav nav-wizard'>
                            ...
                            <li><span class="steps">2</span><a><?php echo $this->lang->line('passengers_details');?></a></li>
                            <li><span class="steps">3</span><a><?php echo $this->lang->line('booking_confirmation');?></a></li>
                        </ul>
