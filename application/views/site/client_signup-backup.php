    ...
    <div class="row">
        <div class="col-md-6 register-page-divider"><!-- col-md-offset-3-->
            <div id="total-login">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="input-group input-group-lg in-ty"> 
                        <select style="background: url(images/user.png) no-repeat 10px 10px #fff;
    margin: 0px 0px 0px;
    padding-left: 35px !important;" required name="user-type">
                            <option> - - - - Choose User Type - - - -</option>
                            <option value="6">Client</option>
                            <option value="7">Driver</option>
                            <option value="8">JobSeekers</option>
                            <option value="9">Affiliates</option>
                        </select>
