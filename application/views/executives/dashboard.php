<script type="text/javascript" src="<?php echo base_url();?>assets/system_design/scripts/charts.js"></script>
...
<div class="col-md-12 padding right-p dashboard">
   <div class="content">
                  ...
                  <table class="table table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><a href="<?php echo site_url(); ?>/admin/bookingDetails/<?php echo $row->id; ?>" style="text-decoration:none;"><?php echo $this->lang->line('view_details');?></a></td>
                        </tr>
                        <?php endforeach;?>      
                     </tbody>
                  </table>
                  <a href="<?php echo site_url();?>/settings/todayBookings" style="text-decoration:none;"><input type="button" value="<?php echo $this->lang->line('view_all');?>"></a>
               </div>
            </div>
         </div>
         <div class="col-md-6 padding-p-r">
                  ...
                  <table class="table table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><a href="<?php echo site_url(); ?>/admin/userDetails/<?php echo $row->id; ?>" style="text-decoration:none;"><?php echo $this->lang->line('view_details');?></a></td>
                        </tr>
                        <?php endforeach;?>  
                     </tbody>
                  </table>
                  <a href="<?php echo site_url();?>/admin/customers" style="text-decoration:none;"><input type="button" value="<?php echo $this->lang->line('view_all');?>"></a>
               </div>
            </div>
         </div>
      </div>
