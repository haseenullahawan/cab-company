         ...
         <div class="content">
            <table width="100%" border="0">
               <tr>
                  <td>
                     From,<br />
                     <?php echo $info['name'];?>, Mobile: 
                     <?php echo $info['contact_no'];?>, Email:
                     <?php echo $info['email'];?> ,Booking no:
                     <?php echo $info['booking_no'];?>
                     <br />
                     <?php echo $info['message']; ?><br />
                  </td>
               </tr>
               <tr>
                  <td>&nbsp;</td>
               ...
               <tr align="right">
                  <td><strong>Regards,</strong><br />
                     DIGITAL VEHICLE BOOKING SYSTEM
                  </td>
               </tr>
            </table>
         </div>
