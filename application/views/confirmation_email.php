	...
	<span id="body_style" style="display:block; padding-top:15px;background:#ededed;"> 
        ...
        <table cellpadding="0" cellspacing="0" class="w600" width="600" border="0" bgcolor="#ffffff" style="border-left-width:1px; border-top-width:1px; border-right-width:1px; border-left-style:solid; border-top-style:solid; border-right-style:solid; border-color:#dcdcdc; background:#ffffff; border-collapse:collapse;">
            <tbody>                            
                ...
                <tr>
                    <td class="w20" width="20"></td>
                    <td class="w560" width="560" align="center" valign="top"><a href="http://www.navetteo.fr" target="_blank"><img src="http://www.navetteo.fr/assets/system_design/images/email-logo.png" border="0" alt="" width="200" height="150"></a></td> <!--alt="NOM DU CLIENT"-->
                    <td class="w20" width="20"></td>
                </tr>
                <!-- Border -->
                <tr>
            ...
            <td  align="left" valign="top" width="560" class="w560">
                <table width="186" class="w186" style="border: 1px solid #ffffff;" border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#f6f6f6">
                    <tbody>
                        ...
                        <tr>
                            <td  style="padding: 4px;" colspan="2" valign="top" width="186" class="w186" height="70"> <?php echo $journey_details->pick_point;?> </td>
                        </tr>
                        <tr>
                ...
                <table width="186" class="w186" style="border: 1px solid #ffffff;" border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#f6f6f6">
                    <tbody>
                        ...
                        <tr>
                            <td  style="padding: 4px;" colspan="2" valign="top" width="186" class="w186" height="70"><?php echo $journey_details->drop_point;?> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td  style="color: #ffffff; font-size: 16px;" align="center" valign="middle" bgcolor="#343434" width="93" class="w93" height="40"><?php echo $journey_details->distance;?></td>
                            <td  style="color: #ffffff; font-size: 16px;" align="center" valign="middle" bgcolor="#343434" width="93" class="w93" height="40"><?php echo $journey_details->cost_of_journey . " " . $this->lang->line($locale_info['currency_symbol']);?></td>
                        </tr>
                    </tbody>
                </table>
                <table width="187" class="w182" style="border: 1px solid #ffffff;" border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="#f6f6f6">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" style="padding: 4px;" valign="top" width="182" class="w182" height="70"><p style="margin:0px 0px 5px;"><?php echo $this->lang->line('name') ?>: <?php echo $journey_details->registered_name;?></p><p style="margin:0px 0px 5px;"><?php echo $this->lang->line('email'); ?>: <?php echo $journey_details->email;?></p><p style="margin:0px 0px 5px;"><?php echo $this->lang->line('phone'); ?>: <?php echo $journey_details->phone;?></p> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="color: #ffffff; font-size: 16px;" align="center" valign="middle" bgcolor="#343434" width="93" class="w93" height="40"><?php if ($journey_details->is_conformed == 'confirm') { echo 'confirmed'; } else { echo $journey_details->is_conformed;  }?></td>
                        </tr>
                    </tbody>
                </table>
            </td>
...
<p>
	<p><?php echo $this->lang->line('regards');?>,</p>
...
<!--footer.tpl-->
        ...
        <table cellpadding="0" cellspacing="0" class="w600" width="600" border="0" bgcolor="#ffffff" style="border-left-width:1px; border-bottom-width:1px; border-right-width:1px; border-left-style:solid; border-bottom-style:solid; border-right-style:solid; border-color:#dcdcdc; background:#ffffff; border-collapse:collapse;">
            <tr>
                <td><p style="padding:0px 20px;"><?php echo $this->lang->line('booking_email_note'); ?></p></td>
            </tr>
        </table>
        <table cellpadding="0" cellspacing="0" class="w600" width="600" border="0" bgcolor="#ffffff" style="border-left-width:1px; border-bottom-width:1px; border-right-width:1px; border-left-style:solid; border-bottom-style:solid; border-right-style:solid; border-color:#dcdcdc; background:#ffffff; border-collapse:collapse;">
            <tbody>
