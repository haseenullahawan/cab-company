...
class Smtp_Model extends CI_Model {
	...
	function smtp_validate($cvReq = true){
		$reqInputs = [
			'status'      => 'Notification Status',
			'name'      => 'Notification Name',
			'smtp_host' 	=> 'SMTP Notification Host',
			'smtp_user' 	=> 'SMTP Notification User',
			'smtp_password' 	=> 'SMTP Notification Password',
			'smtp_status_1'      => 'Newsletter Status',
			'smtp_name_1'      => 'Newsletter Name',
			'smtp_host_1' 	=> 'SMTP Newsletter Host',
			'smtp_user_1' 	=> 'SMTP Newsletter User',
			'smtp_password_1' 	=> 'SMTP Newsletter Password',
			// 'status1'      => 'Callback Status',
			// 'name1'      => 'Callback Name',
			// 'host1' 	=> 'Callback Host',
			// 'call_from' 	=> 'Call From',
			// 'call_to' 	=> 'Call To',
			// 'auto_take_link' 	=> 'Auto Take Link',
		];
