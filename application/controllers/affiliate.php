...

{
    function __construct()
    {
       ...
       // else
        ...
        $this->data['title'] = "Affiliate Dashboard";
    ...
    */
     public function index() {
        $this->data['css_type'] 	= array("form","datatable");
        $this->data['active_class'] = "Affiliate";
       ...
       $this->data['zipcode'] = array(
        ...
        $this->data['content'] 		= 'site/affiliates';
    ...
    public function signup() {
        ...
        $this->data['active_class'] = "Affiliate";
        $this->data['gmaps'] 		= false;
        $this->data['title'] 		= 'Affiliate Signup';
        $this->data['subtitle'] 	= 'Start making money';
        $this->data['title_link'] 	= '#';
        ...
        $this->data['address'] = array('name' => 'address', 'class' => 'user form-control', 'placeholder' => 'Address','rows' => '1', 'cols' => '40','id' => 'address',   'type' => 'text',  'value' => $this->form_validation->set_value('address'));
        $this->data['address1'] = array('name' => 'address1', 'class' => 'user form-control', 'placeholder' => 'Address 1','rows' => '1', 'cols' => '40','id' => 'address',   'type' => 'text',  'value' => $this->form_validation->set_value('address'));
        ...
        $this->data['content'] 		= 'site/affiliate_signup';
    ...
    public function login() {
        ...
        $this->data['subtitle'] 	= 'Affiliate Login';
        ...
        $this->data['content'] 		= 'site/affiliate_login';
    ...
    public function dashboard() {
        ...
        $this->data['content']  = 'affiliate/dashboard';
        $this->data['forgot_form']  = false;  
         
        $this->_render_page('templates/affiliate_template', $this->data);
    }
    /* ENDS by Saravanan.R */
