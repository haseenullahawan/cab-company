...
class Getclient extends CI_Controller 

{
    ...
    $this->load->view("admin.clients.index");
    }
...
// 		$this->load->view('admin.clients.index');
		...
		$pre_nom=$this->input->post('pre_nom');
		...
		$payment_delay=$this->input->post('payment_delay');
		$note=$this->input->post('note');
		$this->load->model('client_model');
//call saverecords method of Hello_Model and pass variables as parameter
		$this->client_model->saverecords($status,$civilite,$nom,$pre_nom,$company,$address1,$address2,$email,$phone,$mobile,$fax,$code_postal,$ville,$client_type,$birthday,$disabled,$payment_method,$payment_delay,$note);		
...
//     //     $this->data['css_type'] 	= array("form","datatable");
//     //     $this->data['active_class'] = "Config Cars";
//     //     $this->data['gmaps'] 		= false;
//     //     $this->data['title'] 		= $this->lang->line("configurations");
//     //     $this->data['subtitle'] 	= 'Config Cars';
//     //     $this->data['title_link'] 	= '#';
//     //     $this->data['content'] 		= 'admin/cars/configurations';
//     //     $data = [];
...
//     // public function getclientaddedprocess(){
//     //     extract($_GET);
//     //     $caradds = $this->client_model->getdata('vbs_client');
//     //     $tbody = '';
//     //     if(!empty($caradds)){
//     //         $i = 1;
